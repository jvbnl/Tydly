...
public enum AutonomyLevel: Int, Comparable, CaseIterable, Equatable {
    case observe = 0
    case propose = 1
    case trustedRule = 2
    case auto = 3
...
public enum FileKind: String, Equatable, CaseIterable {
    case screenshot
    case invoice
    case deck
    case document
...
public struct FilingRule: Identifiable, Equatable {
    public let id: String
    public var name: String
...
public struct ParkedItem: Identifiable, Equatable {
    public let id: String
...
public struct ActionLogEntry: Identifiable, Equatable {
    public let id: String
...
public struct WorkingItem: Identifiable, Equatable {
    public let id: String
...
public struct FolderScope: Equatable {
